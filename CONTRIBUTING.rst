...
----------------------------------
1. Check that you have the latest version of :code:`pykeen_playtime`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/cthoyt/pykeen-playtime/issues
...
.. code-block:: sh
    ...
    $ git clone https://github.com/<YourUsername>/pykeen-playtime
...
If you spend a while working on your changes, further commits may be made to the main :code:`pykeen_playtime`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/cthoyt/pykeen-playtime
